...
for (var variable of valores) 
{
    if(typeof(variable) === "string")
    {
        ...
        else
        {
            ...
            {
                msg += "\nLa palabra "+variable+"("+variable.length+") es mas larga que "+str1+"("+str1.length+")\n";
            }
            else
            {
                msg += "\nLas palabras "+variable+" y "+str1+" tienen la misma longitud "+str1.length+"\n";
            }
        }
    }
